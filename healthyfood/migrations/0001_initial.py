# Generated by Django 2.0.2 on 2018-02-10 16:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.SmallIntegerField(unique=True, verbose_name='code')),
                ...
                ('butyric_acid', models.FloatField(default=0.0, help_text='acide butyrique (acides gras saturés 4:0) (g/100g)', verbose_name='acide butyrique')),
                ('caproic_acid', models.FloatField(default=0.0, help_text='acide caproïque (acides gras saturés 6:0) (g/100g)', verbose_name='acide caproïque')),
                ('caprylic_acid', models.FloatField(default=0.0, help_text='acide caprylique (acides gras saturés 8:0) (g/100g)', verbose_name='acide caprylique')),
                ('capric_acid', models.FloatField(default=0.0, help_text='acide caprique (acides gras saturés 10:0) (g/100g)', verbose_name='acide caprique')),
                ('lauric_acid', models.FloatField(default=0.0, help_text='acide laurique (acides gras saturés 12:0) (g/100g)', verbose_name='acide laurique')),
                ('myristic_acid', models.FloatField(default=0.0, help_text='acide myristique (acides gras saturés 14:0) (g/100g)', verbose_name='acide myristique')),
                ('palmitic_acid', models.FloatField(default=0.0, help_text='acide palmitique (acides gras saturés 16:0) (g/100g)', verbose_name='acide palmitique')),
                ('stearic_acid', models.FloatField(default=0.0, help_text='acide stéarique (acides gras saturés 18:0) (g/100g)', verbose_name='acide stéarique')),
                ('oleic_acid', models.FloatField(default=0.0, help_text='acide oléique (acides gras insaturés 18:1) (g/100g)', verbose_name='acide oléique')),
                ('linoleic_acid', models.FloatField(default=0.0, help_text='acide linoléique (acides gras insaturés 18:2) (g/100g)', verbose_name='acide linoléique')),
                ('alpha_linoleic_acid', models.FloatField(default=0.0, help_text='acide alpha-linoléique (acides gras insaturés 18:3) (g/100g)', verbose_name='acide alpha-linoléique')),
                ('arachidic_acid', models.FloatField(default=0.0, help_text='acide arachidonique (acides gras saturés 20:3) (g/100g)', verbose_name='acide arachidonique')),
                ('epa', models.FloatField(default=0.0, help_text='acide eicosapentaénoïque (acides gras insaturés 20:4) (g/100g)', verbose_name='EPA')),
                ('dha', models.FloatField(default=0.0, help_text='acide docosahexaénoïques(acides gras insaturés 22:6) (g/100g)', verbose_name='DHA')),
                ...
                ('selenium', models.FloatField(default=0.0, help_text='sélénium (mg/100g)', verbose_name='sélénium')),
                ...
                ('vitamin_e', models.FloatField(default=0.0, help_text='vitamine E (µg/100g)', verbose_name='vitamine E')),
                ...
                ('vitamin_c', models.FloatField(default=0.0, help_text='vitamine C (µg/100g)', verbose_name='vitamine C')),
                ('vitamin_b1', models.FloatField(default=0.0, help_text='vitamine B1 (thiamine) (µg/100g)', verbose_name='vitamine B1')),
                ('vitamin_b2', models.FloatField(default=0.0, help_text='vitamine B2 (riboflavine) (µg/100g)', verbose_name='vitamine B2')),
                ('vitamin_b3', models.FloatField(default=0.0, help_text='vitamine B3 (niacine) (µg/100g)', verbose_name='vitamine B3')),
                ('vitamin_b5', models.FloatField(default=0.0, help_text='vitamine B5 (acide penthothénique) (µg/100g)', verbose_name='vitamine B5')),
                ('vitamin_b6', models.FloatField(default=0.0, help_text='vitamine B6 (µg/100g)', verbose_name='vitamine B6')),
