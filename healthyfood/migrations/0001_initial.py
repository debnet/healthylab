...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Food',
            fields=[
                ('code', models.SmallIntegerField(help_text='code interne utilisé par le fichier SIQUAL', primary_key=True, serialize=False, verbose_name='code')),
        ...
        migrations.CreateModel(
            name='FoodGroup',
            fields=[
                ('code', models.CharField(help_text='code interne utilisé par le fichier SIQUAL.', max_length=6, primary_key=True, serialize=False, verbose_name='code')),
                ('name', models.CharField(max_length=1000, verbose_name='nom')),
                ('level', models.PositiveSmallIntegerField(choices=[(1, 'groupe'), (2, 'sous-groupe'), (3, 'sous-sous-groupe')], default=1, help_text='niveau de regroupement (groupe, sous-groupe ou moins)', verbose_name='niveau')),
                ('parent', models.ForeignKey(blank=True, help_text="groupe parent si il s'agît d'un sous-groupe", null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subgroups', to='healthyfood.FoodGroup', verbose_name='parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_time', models.PositiveSmallIntegerField(blank=True, help_text="temps de livraison (en mn) estimé jusqu'à cette salle de sport", null=True, verbose_name='temps de livraison')),
                ('active', models.BooleanField(default=True, help_text='salle de sport activée et livrable', verbose_name='actif')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('energy', models.FloatField(default=0.0, help_text='énergie (en kcal/100g), peut être recalculé sur la base des aliments constituants', verbose_name='énergie')),
                ('protein', models.FloatField(default=0.0, help_text='protéines (en g/100g), peut être recalculé sur la base des aliments constituants', verbose_name='protéines')),
                ('carb', models.FloatField(default=0.0, help_text='glucides (en g/100g), peut être recalculé sur la base des aliments constituants', verbose_name='glucides')),
                ('lipid', models.FloatField(default=0.0, help_text='lipides (en g/100g), peut être recalculé sur la base des aliments constituants', verbose_name='lipides')),
                ('active', models.BooleanField(default=True, help_text='actif à la vente', verbose_name='actif')),
                ('quantity_low', models.PositiveSmallIntegerField(default=0, help_text='quantité nécessaire (en g.) pour une perte de poids', verbose_name='quantité basse')),
                ('quantity_base', models.PositiveSmallIntegerField(default=0, help_text='quantité nécessaire (en g.) pour un maintien du poids', verbose_name='quantité moyenne')),
                ('quantity_high', models.PositiveSmallIntegerField(default=0, help_text='quantité nécessaire (en g.) pour une prise de poids', verbose_name='quantité elevée')),
                ('price_low', models.DecimalField(decimal_places=2, default='0', help_text='prix (en euros) de ce plat avec la quantité nécessaire à une perte de poids', max_digits=4, verbose_name='prix bas')),
                ('price_base', models.DecimalField(decimal_places=2, default='0', help_text='prix (en euros) de ce plat avec la quantité nécessaire à un maintien de poids', max_digits=4, verbose_name='prix de base')),
                ('price_high', models.DecimalField(decimal_places=2, default='0', help_text='prix (en euros) de ce plat avec la quantité nécessaire à une prise de poids', max_digits=4, verbose_name='prix haut')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.date.today, help_text='date de la prise de repas', verbose_name='date')),
                ('type', models.PositiveSmallIntegerField(blank=True, choices=[(1, 'déjeuner'), (2, 'dîner'), (3, 'collation'), (4, 'souper')], help_text='type ou moment de la prise de repas', null=True, verbose_name='type')),
                ('energy', models.FloatField(default=0.0, help_text='énergie (en kcal/100g) du repas', verbose_name='énergie')),
                ('protein', models.FloatField(default=0.0, help_text='protéines (en g/100g) du repas', verbose_name='protéines')),
                ('carb', models.FloatField(default=0.0, help_text='glucides (en g/100g) du repas', verbose_name='glucides')),
                ('lipid', models.FloatField(default=0.0, help_text='lipides (en g/100g) du repas', verbose_name='lipides')),
                ('meal', models.ForeignKey(help_text='repas disponible à la vente ou enregistré par un utilisateur', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='healthyfood.Meal', verbose_name='repas')),
                ('user', models.ForeignKey(help_text='utilisateur concerné', on_delete=django.db.models.deletion.CASCADE, related_name='meals', to=settings.AUTH_USER_MODEL, verbose_name='utilisateur')),
            ],
            options={
                'verbose_name': 'prise de repas',
                'verbose_name_plural': 'prise de repas',
            },
        ),
        migrations.CreateModel(
            name='MealPortion',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('quantity', models.PositiveSmallIntegerField(default=0, help_text='(en g)', verbose_name='quantité')),
                ('food', models.ForeignKey(help_text='ingrédient constituant depuis le fichier SIQUAL', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='healthyfood.Food', verbose_name='aliment')),
                ('meal', models.ForeignKey(help_text='repas concerné', on_delete=django.db.models.deletion.CASCADE, related_name='portions', to='healthyfood.Meal', verbose_name='repas')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('message', models.TextField(blank=True, help_text="commentaire de l'utilisateur (non obligatoire)", verbose_name='commentaire')),
                ('note', models.PositiveSmallIntegerField(choices=[(0, 'zéro'), (1, 'un'), (2, 'deux'), (3, 'trois'), (4, 'quatre'), (5, 'cinq')], default=3, help_text='note du repas (obligatoire)', verbose_name='note')),
                ('meal', models.ForeignKey(help_text='repas concerné', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='healthyfood.Meal', verbose_name='plat')),
                ('user', models.ForeignKey(help_text='utilisateur concerné', on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to=settings.AUTH_USER_MODEL, verbose_name='utilisateur')),
            ],
            options={
                'verbose_name': 'avis',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(auto_now_add=True, help_text='date et heure de la commande', verbose_name='date')),
                ('status', models.PositiveSmallIntegerField(choices=[(1, 'en préparation'), (2, 'en cours de livraison'), (3, 'livré')], default=1, help_text='statut de la commande', verbose_name='statut')),
                ('price', models.DecimalField(decimal_places=2, default='0', help_text='prix (en euros) de la commande', max_digits=4, verbose_name='prix')),
                ('user', models.ForeignKey(help_text='utilisateur concerné', on_delete=django.db.models.deletion.CASCADE, related_name='orders', to=settings.AUTH_USER_MODEL, verbose_name='utilisateur')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(blank=True, choices=[('low', 'perte de poids'), ('base', 'maintien de poids'), ('high', 'prise de poids')], help_text="type de repas choisi selon l'objectif de l'utilisateur", max_length=4, verbose_name='type')),
                ('quantity', models.PositiveSmallIntegerField(default=1, help_text='nombre de repas commandés', verbose_name='quantité')),
                ('price', models.DecimalField(decimal_places=2, default='0', help_text='prix (en euros) de la commande', max_digits=4, verbose_name='prix')),
                ('meal', models.ForeignKey(help_text='repas concerné', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='healthyfood.Meal', verbose_name='repas')),
                ('order', models.ForeignKey(help_text='commande concernée', on_delete=django.db.models.deletion.CASCADE, related_name='items', to='healthyfood.Order', verbose_name='commande')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(default=datetime.date.today, help_text="date de la consommation d'eau", verbose_name='date')),
                ('quantity', models.FloatField(default=0, help_text='(en litres)', verbose_name='quantité')),
                ('user', models.ForeignKey(help_text='utilisateur concerné', on_delete=django.db.models.deletion.CASCADE, related_name='+', to=settings.AUTH_USER_MODEL, verbose_name='utilisateur')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='food',
            name='group',
            field=models.ForeignKey(help_text='groupe auquel appartient cet aliment', on_delete=django.db.models.deletion.CASCADE, related_name='foods', to='healthyfood.FoodGroup', verbose_name='groupe'),
        ),
